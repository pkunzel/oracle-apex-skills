...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/WARN-Procedure.html)
...
Use this page when code needs the `APEX_DEBUG.WARN` procedure. Confirm security, workspace, and session requirements for your calling context.
