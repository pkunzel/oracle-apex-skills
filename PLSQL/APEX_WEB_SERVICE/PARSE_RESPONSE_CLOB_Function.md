...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/PARSE_RESPONSE_CLOB-Function.html)
...
Use this page when code needs the `APEX_WEB_SERVICE.PARSE_RESPONSE_CLOB` function. Confirm security, workspace, and session requirements for your calling context.
