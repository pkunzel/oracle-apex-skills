...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/SET_GROUP_USER_GRANTS-Procedure.html)
...
Use this page when code needs the `APEX_UTIL.SET_GROUP_USER_GRANTS` procedure. Confirm security, workspace, and session requirements for your calling context.
