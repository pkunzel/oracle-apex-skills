...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/APEX_APPLICATION_INSTALL-Data-Types.html)
...
Use this page when code needs the `APEX_APPLICATION_INSTALL.Import Data Types` data types. Confirm security, workspace, and session requirements for your calling context.
