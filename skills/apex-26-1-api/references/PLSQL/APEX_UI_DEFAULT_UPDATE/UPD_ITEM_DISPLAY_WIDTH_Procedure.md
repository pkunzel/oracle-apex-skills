...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/UPD_ITEM_DISPLAY_WIDTH-Procedure.html)
...
Use this page when code needs the `APEX_UI_DEFAULT_UPDATE.UPD_ITEM_DISPLAY_WIDTH` procedure. Confirm security, workspace, and session requirements for your calling context.
