...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/APEX_SESSION_STATE.SET_VALUE-Procedure-Signature-2.html)
...
Set a CLOB value for large text item state.

```sql
begin
    apex_session_state.set_value(
        p_item   => 'P10_NOTE',
        p_value  => to_clob('Reviewed by workflow automation.'),
        p_commit => false);
end;
/
```
