...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/GET_SESSION_TIME_ZONE-Function.html)
...
Use this page when code needs the `APEX_UTIL.GET_SESSION_TIME_ZONE` function. Confirm security, workspace, and session requirements for your calling context.
