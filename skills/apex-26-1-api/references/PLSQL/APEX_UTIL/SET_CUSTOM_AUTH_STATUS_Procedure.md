...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/SET_CUSTOM_AUTH_STATUS-Procedure.html)
...
Use this page when code needs the `APEX_UTIL.SET_CUSTOM_AUTH_STATUS` procedure. Confirm security, workspace, and session requirements for your calling context.
