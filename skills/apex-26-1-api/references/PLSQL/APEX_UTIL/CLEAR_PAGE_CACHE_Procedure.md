...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/CLEAR_PAGE_CACHE-Procedure.html)
...
Use this page when code needs the `APEX_UTIL.CLEAR_PAGE_CACHE` procedure. Confirm security, workspace, and session requirements for your calling context.
