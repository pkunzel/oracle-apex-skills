...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/CACHE_PURGE_STALE-Procedure.html)
...
Use this page when code needs the `APEX_UTIL.CACHE_PURGE_STALE` procedure. Confirm security, workspace, and session requirements for your calling context.
