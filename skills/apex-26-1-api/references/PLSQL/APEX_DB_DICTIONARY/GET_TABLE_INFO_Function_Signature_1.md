...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/APEX_DB_DICTIONARY.GET_TABLE_INFO-Function-Signature-1.html)
...
begin
    l_info := apex_db_dictionary.get_table_info(
        p_table_names             => 'HR.EMPLOYEES, HR.DEPARTMENTS',
