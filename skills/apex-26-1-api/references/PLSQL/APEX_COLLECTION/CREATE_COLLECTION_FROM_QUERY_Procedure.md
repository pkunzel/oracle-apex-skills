...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/CREATE_COLLECTION_FROM_QUERY-Procedure.html)
...
Use this page when code needs the `APEX_COLLECTION.CREATE_COLLECTION_FROM_QUERY` procedure. Confirm security, workspace, and session requirements for your calling context.
