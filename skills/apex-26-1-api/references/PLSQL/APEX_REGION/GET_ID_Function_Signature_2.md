...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/APEX_REGION.GET_ID-Function-Signature-2.html)
...
| `p_name` | Name of the desired region. Note: The p_name is not unique and raises a too_many_rows error if multiple regions exist with the same region name. |
