...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/WRITE-Procedure-Signature-19.html)
...
begin
    ...
    apex_json.write(p_name => 'quantities', p_values => apex_t_number(2, 1, 5), p_write_null => false);
