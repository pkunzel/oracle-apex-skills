...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/WRITE-Procedure-Signature-11.html)
...
begin
    ...
    apex_json.write(p_name => 'orderTotal', p_value => 1250.75, p_write_null => false);
