...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/WRITE-Procedure-Signature-6.html)
...
begin
    ...
    apex_json.write(p_value => sys.xmltype('<order><id>101</id><status>OPEN</status></order>'));
