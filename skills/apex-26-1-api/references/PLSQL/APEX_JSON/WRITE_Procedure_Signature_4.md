...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/WRITE-Procedure-Signature-4.html)
...
begin
    ...
    apex_json.write(p_value => trunc(sysdate), p_format => apex_json.c_date_iso8601);
