...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/WRITE-Procedure-Signature-12.html)
...
begin
    ...
    apex_json.write(p_name => 'createdOn', p_value => trunc(sysdate), p_format => apex_json.c_date_iso8601, p_write_null => false);
