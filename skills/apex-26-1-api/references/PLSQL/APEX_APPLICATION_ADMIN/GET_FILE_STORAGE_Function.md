...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/GET_FILE_STORAGE-Function.html)
...
Use this page when code needs the `APEX_APPLICATION_ADMIN.GET_FILE_STORAGE` function. Confirm security, workspace, and session requirements for your calling context.
...
declare
    l_result VARCHAR2;
begin
    l_result := apex_application_admin.GET_FILE_STORAGE(
        p_application_id => 1
    );
