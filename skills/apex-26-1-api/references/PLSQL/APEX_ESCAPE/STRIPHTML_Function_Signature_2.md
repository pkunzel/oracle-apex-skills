...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/STRIPHTML-Function-Signature-2.html)
...
declare
    l_result clob;
begin
    l_result := apex_escape.striphtml(p_string => to_clob('<p>Only text remains.</p>'));
