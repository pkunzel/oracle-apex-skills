...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/APEX_HUMAN_TASK.SET_INITIATOR_CAN_COMPLETE-Procedure.html)
...
Use this page when code needs the `APEX_HUMAN_TASK.SET_INITIATOR_CAN_COMPLETE` procedure. Confirm security, workspace, and session requirements for your calling context.
