...
```sql
declare
    l_result T_PRINT_CONFIG;
begin
    l_result := apex_data_export.GET_PRINT_CONFIG(
        p_units => null,
        p_paper_size => null,
        p_width_units => null,
        p_width => 1,
        ...
        p_page_header_font_color => null,
        p_page_header_font_family => null,
        p_page_header_font_weight => null,
        p_page_header_font_size => 1,
        p_page_header_alignment => null,
        p_page_footer => 'EXAMPLE',
        p_page_footer_font_color => null,
        p_page_footer_font_family => null,
        p_page_footer_font_weight => null,
        p_page_footer_font_size => 1,
        p_page_footer_alignment => null,
        p_header_bg_color => null,
        p_header_font_color => null,
        p_header_font_family => null,
        p_header_font_weight => null,
        p_header_font_size => 1,
        p_body_bg_color => to_clob('Example text'),
        p_body_font_color => to_clob('Example text'),
        p_body_font_family => to_clob('Example text'),
        p_body_font_weight => to_clob('Example text'),
        p_body_font_size => to_clob('Example text'),
        p_border_width => 1,
        p_border_color => null
    );
