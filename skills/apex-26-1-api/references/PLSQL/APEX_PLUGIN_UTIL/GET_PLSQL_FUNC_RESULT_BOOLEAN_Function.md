...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/GET_PLSQL_FUNC_RESULT_BOOLEAN-Function.html)
...
Use this page when code needs the `APEX_PLUGIN_UTIL.GET_PLSQL_FUNC_RESULT_BOOLEAN` function. Confirm security, workspace, and session requirements for your calling context.
