...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/about-web-credentials-APEX_WEB_SERVICE.html)
...
Use this page when code needs the `APEX_WEB_SERVICE.About Web Credentials and APEX_WEB_SERVICE` about. Confirm security, workspace, and session requirements for your calling context.
