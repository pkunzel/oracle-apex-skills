...
Use this page when code needs the `APEX_PLUGIN.t_region_render_result` topic. Confirm security, workspace, and session requirements for your calling context.
