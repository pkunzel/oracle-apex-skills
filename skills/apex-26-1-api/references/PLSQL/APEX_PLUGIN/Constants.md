...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/APEX_PLUGIN-Constants.html)
...
Covers the documented constants APEX_PLUGIN.Constants.

## When To Use

Use this page when code needs the `APEX_PLUGIN.Constants` constants. Confirm security, workspace, and session requirements for your calling context.
