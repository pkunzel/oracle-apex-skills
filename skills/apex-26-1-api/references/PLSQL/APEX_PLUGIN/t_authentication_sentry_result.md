...
Use this page when code needs the `APEX_PLUGIN.t_authentication_sentry_result` topic. Confirm security, workspace, and session requirements for your calling context.
