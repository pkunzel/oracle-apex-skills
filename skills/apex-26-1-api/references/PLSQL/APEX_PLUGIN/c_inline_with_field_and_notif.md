...
Use this page when code needs the `APEX_PLUGIN.c_inline_with_field_and_notif` topic. Confirm security, workspace, and session requirements for your calling context.
