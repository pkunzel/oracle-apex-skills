...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/REMOVE_PERSISTENT_AUTH-Procedure.html)
...
Use this page when code needs the `APEX_AUTHENTICATION.REMOVE_PERSISTENT_AUTH` procedure. Confirm security, workspace, and session requirements for your calling context.
