...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/POPUPKEY_FROM_LOV-Function.html)
...
Use this page when code needs the `APEX_IR.POPUPKEY_FROM_LOV` function. Confirm security, workspace, and session requirements for your calling context.
...
| --- | --- |
| `p_idx` | Identifies a form element name. For example, 1 equals F01 and 2 equals F02 . Typically, p_idx is a constant for a given column Because of the behavior of POPUPKEY_FROM_QUERY , the next index value should be p_idx + 1 . For example: |
