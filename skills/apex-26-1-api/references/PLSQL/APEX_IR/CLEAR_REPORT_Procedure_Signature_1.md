...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/CLEAR_REPORT-Procedure-Signature-1.html)
...
Use this page when code needs the `APEX_IR.CLEAR_REPORT` procedure. Confirm security, workspace, and session requirements for your calling context.
...
Clear report settings for a saved report by numeric report ID.
