...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/APEX_EXEC.PURGE_DUALITY_VIEW_CACHE-Procedure.html)
...
Use this page when code needs the `APEX_EXEC.PURGE_DUALITY_VIEW_CACHE` procedure. Confirm security, workspace, and session requirements for your calling context.
...
```sql
begin
    apex_exec.purge_duality_view_cache(p_static_id => 'ORDERS_DV', p_current_session_only => true);
end;
/
```
