...
Use this page when code needs the `APEX_EXEC.Querying a Data Source with APEX_EXEC` topic. Confirm security, workspace, and session requirements for your calling context.
