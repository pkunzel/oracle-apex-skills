...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/SET_SCHEMA-Procedure.html)
...
Use this page when code needs the `APEX_APPLICATION_INSTALL.SET_SCHEMA` procedure. Confirm security, workspace, and session requirements for your calling context.
