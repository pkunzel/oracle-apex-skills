...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/GET_REMOTE_SERVER_AI_HEADERS-Function.html)
...
Use this page when code needs the `APEX_APPLICATION_INSTALL.GET_REMOTE_SERVER_AI_HEADERS` function. Confirm security, workspace, and session requirements for your calling context.
