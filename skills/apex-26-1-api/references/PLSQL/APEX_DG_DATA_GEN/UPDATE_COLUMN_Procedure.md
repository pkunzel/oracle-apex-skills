...
Source: [Oracle APEX 26.1 API Reference](https://docs.oracle.com/en/database/oracle/apex/26.1/aeapi/UPDATE_COLUMN-Procedure.html)
...
Use this page when code needs the `APEX_DG_DATA_GEN.UPDATE_COLUMN` procedure. Confirm security, workspace, and session requirements for your calling context.
